...
#include "VerticalEditableTextBox.generated.h"

class SVerticalEditableTextBox;
 ...
 * * Text Entry
 */
UCLASS(meta = (DisplayName = "Vertical Text Box"), MinimalAPI)
class UVerticalEditableTextBox : public UWidget
{
...
protected:
	TSharedPtr<SVerticalEditableTextBox> MyVerticalEditableTextBlock;
