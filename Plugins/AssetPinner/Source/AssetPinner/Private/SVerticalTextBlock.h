...
class SVerticalTextBlock : public SLeafWidget
{
	SLATE_DECLARE_WIDGET_API(SVerticalTextBlock, SLeafWidget, ASSETPINNER_API)
...
public:
	...
	const FText& GetText() const
	{
		...
		{
			SVerticalTextBlock& MutableSelf = const_cast<SVerticalTextBlock&>(*this);
...
public:
	...
	void SetApplyLineHeightToBottomLine(TAttribute<bool> InApplyLineHeightToBottomLine);
