 ...
 */
class SVerticalEditableText : public SWidget, public ISlateEditableTextWidget
{
public:
	SLATE_BEGIN_ARGS(SVerticalEditableText)
		: _Text()
		, _HintText()
		, _SearchText()
	 ...
	 */
	bool SetEditableText(const FText& InNewText);
	...
	void SetEnableIntegratedKeyboard(const TAttribute< bool >& InEnableIntegratedKeyboard);
